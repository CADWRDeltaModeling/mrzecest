""" Estimate the Martinez EC model using GEKKO. 
    This is not successful, at least as implemented,
    so the output is not tidied up.
    The setup was a fair amount of work so we retained it for future
    consideration
"""

import from fitting_util import *
import pandas as pd
import numpy as np
from vtools import *
import scipy
...
def fit_mrzecest_gekko(config, elev=None, ndo=None, ec_obs=None):
